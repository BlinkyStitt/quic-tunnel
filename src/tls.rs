...
pub fn build_client_config(
    ...
    // let mut client_key = rustls_pemfile::private_key(&mut key_reader)?;
    // assert_eq!(client_key.is_some(), 1);
    // let client_key = PrivateKey(client_key.unwrap().secret_der().to_vec());
